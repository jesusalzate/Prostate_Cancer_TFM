...
nnUNetv2_train 14 3d_fullres 4 -tr nnUNetTrainer_100epochs -pretrained_weights /nvmescratch/ceib/Prostate/nnUnet/nnUNet_results/Dataset013_PicaiP158/nnUNetTrainer_100epochs__nnUNetPlans__3d_fullres/fold_0/checkpoint_best.pth -p nnUNetPlans_patch256 